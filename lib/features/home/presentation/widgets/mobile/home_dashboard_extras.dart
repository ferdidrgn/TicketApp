...
/// Konuma (varsa) veya kullanıcının şehrine göre sıralanmış, biletleri
/// hâlâ satılabilir olan yaklaşan etkinliklerden ilk 10'unu gösterir.
/// Hiç uygun etkinlik yoksa (hepsi bitmiş/dolu/tarihsiz) sessizce
/// hiçbir şey render etmez — "olmayan" etkinlikleri anasayfada göstermeyiz.
class NearbyEventsDashboardSection extends ConsumerWidget {
  const NearbyEventsDashboardSection({super.key});
    ...
    return Column(
      ...
      children: [
        SectionHeader(
          ...
          subtitle: hasLocation ? 'Konumuna göre' : 'Şehrine göre önerilen',
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (final context, final index) {
              ...
              final dateInfo = DateFormatter.parseFormattedDateTime(
                  item.event.date,
              ...
              return EventsCard(
                ...
                price: item.price,
                fullDateString: dateInfo['date'] ?? '',
                timeString: dateInfo['time'] ?? '',
                onTap: () {
                  HapticFeedback.lightImpact();

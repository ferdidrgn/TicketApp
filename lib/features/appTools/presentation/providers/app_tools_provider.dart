...
import 'package:ticketapp/features/appTools/data/repositories/app_tools_repository_provider.dart';
import 'package:ticketapp/features/appTools/domain/usecases/get_privacy_policy_use_case_impl.dart';
import 'package:ticketapp/features/appTools/domain/usecases/get_terms_condition_use_case_impl.dart';
import 'app_tools_notifier.dart';
import 'app_tools_state.dart';

/// Uygulama araçları ViewModel provider'ı
final appToolsProvider =
    NotifierProvider.autoDispose<AppToolsNotifier, AppToolsState>(

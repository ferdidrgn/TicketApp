...
class GozYapVazYapLanding extends StatelessWidget {
  ...
  // Teknik Ekip Listesi (Veriler korundu)
  ...
  Widget build(final BuildContext context) => Container(
        ...
        color: WebColors.darkBlueBackground, // Arka plan tüm ekranı kaplar
        child: Center(
          // İÇERİK 1400PX İLE SINIRLANDI VE ORTALANDI
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // Hero Section'a kenar boşluğu eklendi
                  Padding(
  ...
  Widget _buildDesktopContent(final BuildContext context) => Column(
        children: [
  ...
  // ... (Geri kalan tüm _build metotları aynı, sadece paddingler constraint içinde olduğu için güvende)
  ...
  Widget _buildHeader(final BuildContext context) => Container(
        width: double.infinity,
        padding: context.responsive(
          mobile: const EdgeInsets.symmetric(vertical: 32),
          desktop: const EdgeInsets.symmetric(vertical: 48),
        ),
        child: ClipRRect(
                ...
                children: [
                  ShaderMask(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize:
                            context.responsive(mobile: 26.0, desktop: 40.0),
                        fontWeight: FontWeight.w900,
                        color: Colors.white,
                        letterSpacing: 1.5,
                        height: 1.2,
  ...
  Widget _buildHeroSection(final BuildContext context) => Container(
  ...
  // _buildAboutSection, _buildTechnicalTeam, _buildSecondImageManifesto, _buildText aynen kalacak...
  // Bu kısımlarda bir değişiklik yok, sadece _buildHeroSection içinde ClipRRect ekledim.

  Widget _buildAboutSection(final BuildContext context) => Container(
  ...
  Widget _buildTechnicalTeam(final BuildContext context) => Container(
        width: double.infinity,
        padding: const EdgeInsets.all(24),
        decoration: BoxDecoration(
          color: WebColors.darkBlueSurface.withOpacity(0.5),
  ...
  Widget _buildSecondImageManifesto(final BuildContext context) => Container(
        height: context.responsive(mobile: 350.0, desktop: 500.0),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(20),
          boxShadow: [
  ...
  Widget _buildText(final BuildContext context, final String text) => Text(text,
      style: TextStyle(

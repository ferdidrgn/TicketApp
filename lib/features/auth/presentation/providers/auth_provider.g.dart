...
final class SignInAnonymouslyUseCaseProvider extends $FunctionalProvider<
    SignInAnonymouslyUseCase,
    SignInAnonymouslyUseCase,
    SignInAnonymouslyUseCase> with $Provider<SignInAnonymouslyUseCase> {
...
String _$signInAnonymouslyUseCaseHash() =>
    r'f07d00d43f138e5310563fe02dd5c823cd81a343';

@ProviderFor(verifyPhoneUseCase)
const verifyPhoneUseCaseProvider = VerifyPhoneUseCaseProvider._();

final class VerifyPhoneUseCaseProvider extends $FunctionalProvider<
    VerifyPhoneUseCase,
    VerifyPhoneUseCase,
    VerifyPhoneUseCase> with $Provider<VerifyPhoneUseCase> {
...
String _$verifyPhoneUseCaseHash() =>
    r'6ad2398a73b63f630688ce4dd2240dbddaf6a351';

@ProviderFor(verifyOtpUseCase)
const verifyOtpUseCaseProvider = VerifyOtpUseCaseProvider._();

final class VerifyOtpUseCaseProvider extends $FunctionalProvider<
    VerifyOtpUseCase,
    VerifyOtpUseCase,
    VerifyOtpUseCase> with $Provider<VerifyOtpUseCase> {
...
String _$verifyOtpUseCaseHash() => r'b51afbce6f1d3216ee027b3e7ebb1529c4995dd4';
...
String _$deleteAccountUseCaseHash() =>
    r'da56919d9a6a0efaa8c15296d1363e63b11c6a54';

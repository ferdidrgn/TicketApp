...
class _InfoAndCast extends StatelessWidget {
  const _InfoAndCast({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('OYUN EKİBİ',
              style: TextStyle(
                  color: WebColors.primaryGold, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
...
class _CastCard extends StatefulWidget {
  ...
  const _CastCard(
      {Key? key, required this.name, this.role = '', this.isCompact = false})
      : super(key: key);
